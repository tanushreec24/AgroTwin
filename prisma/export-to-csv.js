...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.plot.findMany({
                        include: {
                            farm: true,
                            crop: true,
                            sensors: {
                ...
                case 1:
                    plots = _a.sent();
                    rows = plots.map(function (plot) {
                        var _a, _b;
                        // Get latest readings for each sensor type
                        var readings = {};
                        plot.sensors.forEach(function (sensor) {
                            if (sensor.readings.length > 0) {
                                readings[sensor.type] = sensor.readings[0].value;
                            }
                        });
                        // Find irrigation action if available
                        var irrigationAction = plot.actions.find(function (a) { return a.type === client_1.ActionType.Irrigation; });
                        return {
                            farm_name: plot.farm.name,
                            state: plot.farm.state,
                            district: plot.farm.district,
                            plot_id: plot.id,
                            crop: ((_a = plot.crop) === null || _a === void 0 ? void 0 : _a.commonName) || ((_b = plot.crop) === null || _b === void 0 ? void 0 : _b.name),
                            rainfall: readings['RAINFALL'],
                            temperature: readings['TEMPERATURE'],
                            soil_moisture: readings['SOIL_MOISTURE'],
                            // Uncomment and adjust if you have these fields:
                            // yield: plot.actualYield,
                            // irrigation_applied: irrigationAction?.amount,
                        };
                    });
                    csv = (0, json2csv_1.parse)(rows);
                    // Write to file
